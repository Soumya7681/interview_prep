# Appendix — Documents & Questions to Ask
...
> 💡 Keep all of the above in a single folder titled "TCS_Interview_<date>" — soft copies in Drive, hard copies in a sleeve. Speed and tidiness signal preparedness.
...
5. *"What's the tech stack in production today, and is there appetite to evolve it?"*
6. *"How do code reviews, deployments, and on-call work here?"*
7. *"What's the test culture — what does CI look like?"*
8. *"How do you handle technical debt — dedicated time, opportunistic, or hackathons?"*

### About Growth
9. *"What are the growth opportunities for full-stack engineers — both technical (senior / staff) and managerial?"*
10. *"What internal learning or certification programs are available?"*

### About the Team / Culture (later rounds)
11. *"What's the most exciting problem your team has solved recently?"*
12. *"What kind of engineer thrives here, in your experience?"*
13. *"What's the biggest challenge facing the team right now?"*

### Closing the Loop
14. *"What are the next steps in the process?"*
15. *"Is there anything you'd like me to clarify or expand on from this conversation?"*
